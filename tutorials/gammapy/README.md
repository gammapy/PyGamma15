...
Install the development version of Gammapy by cloning [this](https://github.com/gammapy/gammapy) git repository and running ``python setup.py install``. For the spectral fit you also need Sherpa 4.7 and Python 2.7 (see [here](https://gammapy.readthedocs.org/en/latest/install.html#id1)).
